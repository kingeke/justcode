...
export function buildSystemPrompt(
  ...
  sections.push(
    ...
    'then call it with {"enable": [...]} to activate just the ones the task',
    'needs before calling them. Disable tools you are done with via',
    '{"disable": [...]} when switching to a different kind of task, so requests',
    'stay small. Paths are relative to the workspace root.',
    '',
    'Available tools:',
    toolLines
  );
